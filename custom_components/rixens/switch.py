...
SWITCH_DESCRIPTIONS: tuple[RixensSwitchEntityDescription, ...] = (
    RixensSwitchEntityDescription(
        ...
        value_fn=lambda data: data.settings.furnace_src != 0,  # 0 = disabled, 1/2 = enabled
    ...
    RixensSwitchEntityDescription(
        ...
        value_fn=lambda data: data.settings.floor_src != 0,  # 0 = disabled, 1/2 = enabled
    ...
    RixensSwitchEntityDescription(
        ...
        value_fn=lambda data: data.settings.electric_src != 0,  # 0 = disabled, 1/2 = enabled
